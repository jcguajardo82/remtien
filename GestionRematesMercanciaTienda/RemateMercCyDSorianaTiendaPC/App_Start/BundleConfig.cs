...
namespace Inspinia_MVC5
{
    public class BundleConfig
    {
        ...
        {
            bundles.Add(new ScriptBundle("~/Scripts/AutFolio").Include("~/Scripts/FolioMciaCaduca/Folio.Mercancia.Caduca.index.js"));
            bundles.Add(new ScriptBundle("~/Scripts/RepCapturaMercanciaCaducar").Include("~/Scripts/Reportes/General/CapturaMercanciaCaducar/dashboard.CapturaMercanciaCaducar.index.js"));
            bundles.Add(new ScriptBundle("~/Scripts/RepActaDestruccion").Include("~/Scripts/Reportes/General/ActaDestruccion/dashboard.ActaDestruccion.index.js"));
            bundles.Add(new ScriptBundle("~/Scripts/RepArtRemVencidos").Include("~/Scripts/Reportes/General/ArtRemVencidos/dashboard.ArtRemVencidos.index.js"));
            bundles.Add(new ScriptBundle("~/Scripts/RepArtProxCadEtapa").Include("~/Scripts/Reportes/General/ArtProxCadEtapa/dashboard.ArtProxCadEtapa.index.js"));
            bundles.Add(new ScriptBundle("~/Scripts/RepMerma").Include("~/Scripts/Reportes/General/Merma/dashboard.Merma.index.js"));
            bundles.Add(new ScriptBundle("~/Scripts/RepReimpresionEtiqueta").Include("~/Scripts/Reportes/General/ReimpresionEtiqueta/dashboard.ReimpresionEtiqueta.index.js"));
